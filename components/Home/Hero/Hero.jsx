...
const Hero = () => {
  ...
  const handleGetStartedClick = () => {
    window.location.href =
      "https://olelkx.on-app.in/app/home?orgCode=olelkx&referrer=utm_source=copy-link&utm_medium=tutor-app-referral";
  };

  const handleGetFreeTrialClick = () => {
    window.location.href = "https://forms.gle/cYgDjY7qJCLVER9w5";
  };
      ...
      <section className={styles.hero_container} id="hero">
        ...
        <div className={styles.hero_data}>
          ...
          <div className={styles.button_container}>
            <button className={styles.btn1} onClick={handleGetStartedClick}>
              Get Started
            </button>
            <button className={styles.btn2} onClick={handleGetFreeTrialClick}>
              Get Free trial
            </button>
          </div>
